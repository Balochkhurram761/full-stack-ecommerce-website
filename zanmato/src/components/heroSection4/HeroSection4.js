...
const HeroSection4 = () => {
  ...
  return (
    <div className="back bg-[#F7FAFC] py-2 hidden sm:hidden md:block lg:block">
      <div className="herosection  flex flex-col lg:flex-row w-[90%] mx-auto cursor-pointer">
        <div className="leftsection w lg:w-[30%] relative">
          <div className="log w-full h-full">
            <img
              ...
              src={require("../../assets/assets/Image/backgrounds/Group 969.png")}
              alt=""
            />
          </div>
          <div className="body relative md:relative lg:absolute top-0 left-0 p-5 flex flex-col items-start gap-2">
            <h1 className="text-[20px] font-semibold max-w-[170px]">
              Home and Outdoor
            </h1>
        ...
        <div className="rightsection flex flex-col gap-2 w-[100%]">
          <div className="w-full h-full">
            <div className="cards grid capitalize grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 h-full">
