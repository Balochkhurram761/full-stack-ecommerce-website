...
const MobileNavbar = ({ onclose, menu }) => {
  return (
    <div className="div  block lg:hidden">
      <div
        className={`sidebar w-[270px] overflow-y-auto  fixed top-0 z-20  h-[100vh] bg-white border-[1px] rounded-l-3xl  flex  flex-col  px-5 py-7 gap-3 transition-transform duration-500  ${
          menu
      ...
      >
        ...
        <div className="navlinks">
          <ul className="flex leading-[43px] flex-col text-[#777] font-medium text-[16px]">
            <li>
